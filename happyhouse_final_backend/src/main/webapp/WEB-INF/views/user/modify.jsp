...
<body>
	...
	<div class="regist-container">
		<h2 class="modify-title">회원 정보 수정</h2>
		<div class="modify-form">
			<form action="" method="post" id="modifyform">
				<label for="userid">ID(*20자 이내):</label> 
				<input type="text" class="form-control" id="userid" name="userId" placeholder="${userinfo.userId}" > 
				<label for="userpw">Password:</label> 
				<input type="password" class="form-control" id="userpwd" name="userPwd" placeholder="${userinfo.userPwd}"> 
				...
				<input type="text" class="form-control" id="userphone" name="phone" placeholder="${userinfo.phone}"> 
				<label for="useremail">E-mail(*20자 이내):</label> 
				<input type="email"	class="form-control" id="useremail" name="email" placeholder="${userinfo.email}">
				<button type="button" class="btn btn-primary modify-btn" id="Modify">수정하기</button>
			</form>
		</div>
	</div>
</body>
