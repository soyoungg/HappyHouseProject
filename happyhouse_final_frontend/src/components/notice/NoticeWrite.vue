<template>
  <div class="write-div">
    <div class="write-title" style="margin:10px;">
      <label for="title" style="margin:10px;">제목</label>
      <input type="text" class="write-title-input" style="margin:10px;">
      <br>
    </div>
...
import MenuBar from '@/components/texteditor/MenuBar.vue'
